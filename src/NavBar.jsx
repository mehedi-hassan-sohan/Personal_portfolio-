    ...
    <>
      <div className="mt-2 flex justify-center items-center   p-2">
        ...
        <div className="navbar">
          <a className="btn font-serif btn-ghost normal-case text-4xl font-bold">
            Mehedi_Dev
          </a>
        </div>
        <div className="md:flex justify-center  items-center gap-5 mr-10 hidden ">
          ...
          >
            <a className=" font-serif font-semibold" to="/">
              Home
            </a>
          </motion.li>
          <motion.li
          ...
          >
            <a className=" font-serif font-semibold" to="/about">
              About
            </a>
          </motion.li>
          <motion.li
          ...
          >
            <a className=" font-serif font-semibold" to="/projects">
              Projects
            </a>
          </motion.li>
          <motion.li
            className="list-none font-serif text-lg font-semibold"
            initial={{ y: -10, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
          ...
          <motion.button 
            ...
            className="btn font-serif btn-outline duration-300 ml-4" 
          >
        <a href='SohanDev_Cv.pdf' download>
      ...
      >
        ...
        <a href='updated-resume.pdf' download>
         <button>Download Resume</button>
       </a>
